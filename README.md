...
![表紙絵](https://raw.github.com/ukyo/comike84-js/master/cover.png)

コミックマーケット84 8月11日 東R14bにて **JavaScriptの薄い本** を頒布します。

##内容

* ECMAScript5.1オブジェクトに関連する章の解説
* Emscripten入門

##想定の読者

* JavaScriptを問題なく読み書きできる
* Linuxの基礎的な知識がある
